...
const PurchaseEntry = () => {
  ...
  //     const { quantity, single_price, gstpre } = product;
  //     const totalPrice = quantity * single_price;
  //     const gstAmount = (totalPrice * gstpre) / 100;
  //     const cgstTotal = gstAmount / 2;
  //     const sgstTotal = gstAmount / 2;
  //     const totalAmount = totalPrice + gstAmount;
  //     console.log(gstpre);

  //     // Initialize the summary object for this GST percentage if it doesn't exist
  //     if (!summary[gstpre]) {
  //       summary[gstpre] = {
  //         taxableAmount: 0,
  //         cgst: 0,
  ...
  //       };
  //     }
  //     summary[gstpre].taxableAmount += totalPrice;
  //     summary[gstpre].cgst += cgstTotal;
  //     summary[gstpre].sgst += sgstTotal;
  //     summary[gstpre].totalAmount += totalAmount;
  //   });

  //   // Filter out GST percentages with zero taxable amounts
  //   const filteredSummary = Object.keys(summary)
  //     .filter((key) => summary[key].taxableAmount > 0)
  //     .reduce((acc, key) => {
  //       acc[key] = summary[key];
  //       return acc;
  //     }, {});
  ...
  //   setValue("bill_details.gstgrouppycatagry", filteredSummary);
  // };
  // useEffect(() => {
  //   const subscription = watch((value, { name, type, quantity }) => {
  //     if (name && type && quantity === "change") {
  //       const products = getValues("products");
  //       const summary = calculateGstSummary(products);
  //       setValue("bill_details.gstgrouppycatagry", summary);
  //     }
  //   });
